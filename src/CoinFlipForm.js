...
const contractAddress = '0x12bddF8150bA877F32AE0226AA5c17093715AAA5';
...
export async function getEventLogs(provider, contractAddress, contractABI) {
  try {
    ...
    await sleep(5000);
        ...
        // Calculate the 'fromBlock' value by subtracting 1000 blocks from 'latest'
    ...
    const logs = await provider.getLogs({
      ...
      fromBlock: fromBlock, // Replace with the starting block number
      toBlock: 'latest',
